...
= 0.9.10 =
* ?mfa=debug now reports the update check's state: header, filter, a live GitHub call, the version comparison, and anything intercepting WordPress's update machinery.
